    ...
    public partial class FrmNhanVien : Form
    {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SqlCommand cmd = con.CreateCommand();
                    cmd.CommandText = "Update NHANVIEN Set MADUAN = @MADUAN,TENNV=@TENNV,NAMSINH =@NAMSINH,SDTNV=@SDTNV," +
        ...
        private void DataQLDA_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                DateTNamSinh.Value = Convert.ToDateTime(row.Cells[3].Value.ToString());
            }
        }
